...
| `skill-audit/` | Skill freshness audit pipeline — `skill-audit.py` for local inventory/staleness report (92 skills, ANSI table + JSON), `skill-freshness.py` for automated Exa/Firecrawl upstream validation, `freshness-registry.yaml` for curated upstream metadata |
