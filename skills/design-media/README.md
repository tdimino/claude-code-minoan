...
| `minoan-frontend-design` | Frontend design with eval infrastructure (70% win rate). 26 reference files: creative techniques, color science (meodai/color-expert), Stripe/Mintlify/Vercel design tokens, Nielsen heuristics scoring, Impeccable domain refs |
