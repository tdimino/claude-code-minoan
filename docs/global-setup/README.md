...
├── skills/                          # 92 custom skills (SKILL.md + scripts/)
...
Currently 92 skills in the distribution repo. Toggle with `skill-toggle.py`. Disabled skills tracked in `~/.claude/disabled-skills.md`.
