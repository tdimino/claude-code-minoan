...
<p align="center">
  <a href="#available-skills"><img src="https://img.shields.io/badge/Skills-92-green.svg" alt="Skills"></a>
...
```
claude-code-minoan/
├── skills/                      # 92 custom skills across 5 categories
...
### [Skills](skills/README.md) — 92 skills across 5 categories
...
| Research | 9 | `minoan` (reconstructed Minoan language faculty), `omnisearch`, `geo-seo`, `academic-research`, `ancient-near-east-research`, `exa-search`, `firecrawl`, `scrapling`, `openplanter` |
...
**Skills**: 91 | **Commands**: 21 | **Hooks**: 49 | **CLI Tools**: 10
