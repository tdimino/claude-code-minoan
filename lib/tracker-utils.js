...
function loadSessionsIndex() {
  ...
  // Load registry for titles/tags/summaries
...
function tryDb() {
  ...
  } catch { /* tracker-db.js not available or DB not initialized */ }
  _trackerDb = false;
  return null;
}
